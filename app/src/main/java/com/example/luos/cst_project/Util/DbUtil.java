...
public class DbUtil extends SQLiteOpenHelper {
    ...
    public void insertMessage(ContentValues values) {
        ...
        Log.i(TAG, "Insert Message type=" + type + " direction=" + direction + " content=" +
                content + " time=" + time + " self_If=" + self_Id + " friend_Id=" + friend_Id);
    ...
    public ArrayList<Friend> queryFriends(String selfId) {
        ...
        String[] columns = {FriendsEntry.FRIEND_ID, FriendsEntry.NICKNAME, FriendsEntry.TYPE,
                FriendsEntry.CONTENT, FriendsEntry.TIME};
        String selection = FriendsEntry.USER_ID + "=" + selfId + " and " + FriendsEntry.FRIEND_ID
                + "!=" + selfId;
